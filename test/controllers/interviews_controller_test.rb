...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference("Interview.count") do
      post interviews_url, params: { interview: { candidate_position_test_id: @interview.candidate_position_test_id, interview_type: @interview.interview_type, interviewer: @interview.interviewer } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { candidate_position_test_id: @interview.candidate_position_test_id, interview_type: @interview.interview_type, interviewer: @interview.interviewer } }
